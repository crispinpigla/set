...
urlpatterns = [
	...
	url(r"^manage_contact/(?P<contact_id>\w+)/$", views.manage_contact), # "/store" will call the method "index" in "views.py"
	...
	url(r"^messages_exchanges/(?P<user_id>\w+)/$", views.messages_exchanges), # "/store" will call the method "index" in "views.py"
	url(r"^send_message/(?P<user_id>\w+)/$", views.send_message), # "/store" will call the method "index" in "views.py"
	url(r"^updates_messages_user/(?P<user_id>\w+)/$", views.updates_messages), # "/store" will call the method "index" in "views.py"
	url(r"^profil/(?P<user_id>\w+)/$", views.profil), # "/store" will call the method "index" in "views.py"
