...
class AuthentificationViewsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user_registred_not_connected = Utilisateurs.objects.create(
            nom="user_registred_not_connected",
            adresse_mail="user_registred_not_connected@mail.mail",
            mot_de_passe="user_registred_not_connected_password",
            cle_dactivation_de_compte="user_registred_not_connected_cle_dactivation_de_compte",
        )
        self.user_registred_not_connected_reset_password = Utilisateurs.objects.create(
            nom="user_registred_not_connected_reset_password",
            adresse_mail="user_registred_not_connected_reset_password@mail.mail",
            mot_de_passe="user_registred_not_connected_reset_password_password",
            cle_de_reinitialisation_de_mot_de_passe="cle_de_reinitialisation_de_mot_de_passe",
        )
        self.user_registred_connected = Utilisateurs.objects.create(
            nom="user_registred_connected",
            adresse_mail="user_registred_connected@mail.mail",
            mot_de_passe="user_registred_connected_password",
            cle_dactivation_de_compte="cle_dactivation_de_compte",
        )
        ...
        self.client_registred_connected.post(
            "/authentification/connexion/",
            {
                "email": "user_registred_connected@mail.mail",
                "password": "user_registred_connected_password",
            },
        )
    ...
    def test_connexion_ask_page_unconnected_user(self):
        ...
        response = self.client_registred_not_connected.get(
            "/authentification/connexion/"
        )
    ...
    def test_connexion_make_connexion_user_unconnected_success(self):
        ...
        response = self.client_registred_connected.post(
            "/authentification/connexion/",
            {
                "email": "user_registred_not_connected@mail.mail",
                "password": "user_registred_not_connected_password",
            },
        )
        self.assertEqual(response.url, "../../user/home/")
        self.assertTemplateNotUsed(response, "connexion.html")
    ...
    def test_connexion_make_connexion_user_unconnected_to_no_mail_account_in_application(
        self
    ):
        """#  Demande de connexion avec un mail qui ne coresspond à aucun utilisateur de l'application"""
        response = self.client_registred_not_connected.post(
            "/authentification/connexion/",
            {
                "email": "no_mail@mail.mail",
                "password": "user_registred_not_connected_password",
            },
        )
    ...
    def test_connexion_make_connexion_user_unconnected_invalid_form_mail(self):
        ...
        response = self.client_registred_not_connected.post(
            "/authentification/connexion/",
            {
                "email": "user_registred_not_connected@mail",
                "password": "user_registred_not_connected_password",
            },
        )
    ...
    def test_inscription_connected_user(self):
        ...
        response = self.client_registred_connected.post(
            "/authentification/inscription/",
            {
                "name": "user_not_registred",
                "email": "user_not_registred@mail.mail",
                "password": "user_not_registred_password",
                "confirmation_password": "user_not_registred_password",
            },
        )
    ...
    def test_initialisation_mot_de_passe_ask_page_connected_user(self):
        ...
        response = self.client_registred_connected.get(
            "/authentification/initialisation_mot_de_passe/"
        )
        self.assertEqual(response.url, "../../user/home/")
    ...
    def test_initialisation_mot_de_passe_ask_page_unconnected_user(self):
        ...
        response = self.client_registred_not_connected.get(
            "/authentification/initialisation_mot_de_passe/?name=user_not_registred&mail=user_not_registred@mail.mail"
        )
    ...
    def test_envoie_lien_reinitialisation_password_ask_page_connected_user(self):
        ...
        self.assertTemplateNotUsed(
            response, "envoie_lien_reinitialisation_mot_de_passe.html"
        )
        self.assertTrue(response.status_code == 302)
    ...
    def test_envoie_lien_reinitialisation_password_user_mail_exist_in_application(self):
        ...
        self.assertTrue(
            Utilisateurs.objects.get(
                adresse_mail=self.user_registred_not_connected.adresse_mail
    ...
    def test_envoie_lien_reinitialisation_password_user_mail_not_exist_in_application(
        self
    ):
        ...
        response = self.client_registred_not_connected.post(
            "/authentification/envoie_lien_reinitialisation_password/",
            {"email": "not_exist_account@mail.mail"},
        )
        self.assertTrue(
            Utilisateurs.objects.get(
                adresse_mail=self.user_registred_not_connected.adresse_mail
    ...
    def test_reinitialisation_mot_de_passe_ask_page_user_not_connected_invalid_mail(
        self
    ):
        """#  Demande de page de réinitialisation de mot passe avec un mail invalide"""
        response = self.client_registred_not_connected_reset_password.get(
            "/authentification/reinitialisation_password/?mail="
            + "wrong_mail@mail.mail"
            + "&key_reinitialisation_password="
            + self.user_registred_not_connected_reset_password.cle_de_reinitialisation_de_mot_de_passe
        )
        self.assertTemplateUsed(response, "404.html")
        self.assertTrue(response.status_code == 404)

    def test_reinitialisation_mot_de_passe_ask_page_user_not_connected_invalid_key(
        self
    ):
        """#  Demande de page de réinitialisation de mot passe avec une clé invalide"""
        response = self.client_registred_not_connected_reset_password.get(
            "/authentification/reinitialisation_password/?mail="
            + self.user_registred_not_connected_reset_password.adresse_mail
            + "&key_reinitialisation_password="
            + "wrong_key"
        )
        self.assertTemplateUsed(response, "404.html")
    ...
    def test_reinitialisation_mot_de_passe_invalid_form_mail(self):
        ...
        self.assertTrue(
            Utilisateurs.objects.get(
                adresse_mail=self.user_registred_not_connected_reset_password.adresse_mail
            ).cle_de_reinitialisation_de_mot_de_passe
            != None
        )
        response = self.client_registred_not_connected_reset_password.post(
            "/authentification/reinitialisation_password/",
            {
                "reset_key": self.user_registred_not_connected_reset_password.cle_de_reinitialisation_de_mot_de_passe,
                "email": "mail",
    ...
    def test_reinitialisation_mot_de_passe_invalid_form_password(self):
        ...
        response = self.client_registred_not_connected_reset_password.post(
            ...
            {
                "reset_key": self.user_registred_not_connected_reset_password.cle_de_reinitialisation_de_mot_de_passe,
                "email": self.user_registred_not_connected_reset_password.adresse_mail,
                "password": "",
                "confirmation_password": "new_password",
            },
        )
    ...
    def test_google_connect_success(self, mock_get):
        ...
        mock_get.return_value = MockRequest(
            self.user_registred_not_connected.adresse_mail
        )
        response = self.client_registred_not_connected.post(
    ...
    def test_google_connect_no_user_mail(self, mock_get):
        ...
        mock_get.return_value = MockRequest(
            "mail_who_dont_exist_in_application@mail.mail"
        )
        response = self.client_registred_not_connected.post(
            "/authentification/google_connect/?token=1234"
        )
        self.assertTrue(
            response.content == b"Aucun utilisateur n'existe avec ce compte google"
        )
        self.assertTrue(response.status_code == 200)
    ...
    def test_envoie_activation_compte_success(self):
        ...
        activation_key_before = Utilisateurs.objects.get(
            adresse_mail=self.user_registred_connected.adresse_mail
        ).cle_dactivation_de_compte
        response = self.client_registred_connected.post(
            "/authentification/envoie_activation_compte/"
        )
    ...
    def test_activation_compte_unconnected_user(self):
        ...
        response = self.client_registred_not_connected.post(
            ...
            + self.user_registred_not_connected.adresse_mail
            + "&key_activation="
            + self.user_registred_not_connected.cle_dactivation_de_compte
        )
        activation_key_after = Utilisateurs.objects.get(
            adresse_mail=self.user_registred_not_connected.adresse_mail
        ).cle_dactivation_de_compte
    ...
    def test_activation_compte_wrong_mail(self):
        ...
        response = self.client_registred_connected.post(
            ...
            + "wrong_mail"
            + "&key_activation="
            + self.user_registred_connected.cle_dactivation_de_compte
        )
        activation_key_after = Utilisateurs.objects.get(
            adresse_mail=self.user_registred_connected.adresse_mail
        ).cle_dactivation_de_compte
    ...
    def test_activation_compte_wrong_key(self):
        ...
        response = self.client_registred_connected.post(
            "/authentification/activation_compte/?mail="
            + self.user_registred_connected.adresse_mail
            + "&key_activation="
            + "wrong_key"
        )
        activation_key_after = Utilisateurs.objects.get(
