...
class TestsVueUser(TestCase):
    ...
    def setUp(self):
        ...
        self.user_1 = Utilisateurs.objects.create(nom="user_1", adresse_mail="user_1@mail.mail", mot_de_passe='user_1')
        self.user_2 = Utilisateurs.objects.create(nom="user_2", adresse_mail="user_2@mail.mail", mot_de_passe='user_2')
        self.user_3 = Utilisateurs.objects.create(nom="user_3", adresse_mail="user_3@mail.mail", mot_de_passe='user_3')
